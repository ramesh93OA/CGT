...
%>
        <div id="wrapper">
                    ...
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="#"><i class="fa fa fa-users fa-fw"></i> C.S.E</a>
                                    </li>
                                    <li>
            ...
            <div id="page-wrapper">
                  ...
                  <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3>Computer Science & Engineering(C.S.E)</h3>
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <p>Computer Science Engineering (CSE) encompasses a variety of topics that relates to computation,
                                 like analysis of algorithms, programming languages, program design, software, and computer hardware.
                                 Computer Science engineering has roots in electrical engineering, mathematics, and linguistics. In 
                                 the past Computer Science was taught as part of mathematics or engineering departments & in the recent
                                  days it has emerged as a separate engineering field.</p>
                                 <a class="btn btn-default btn-lg btn-block" 
                                 href="../students/page/cse_d.jsp">
                ...
                <form action="mailto:debimps07@gmail.com" method="post" enctype="text/plain">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span style="font-size: 24px;font-weight: bold">
                                Mr. Debasis Mandal  
                                <button style="float:right"  type="submit" class="btn btn-default">Send Mail</button>
                                </span>
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <div class="role col-md-11 col-sm-11 text-center" style="margin:10px;padding:5px!important">
                                        <div class="teacher-overview-block" style="padding: 10px;">
                                            <img style="width: 160px;height:180px; float: left;padding:10px" class="teacher-overview-image" src="../img/debasish.jpg">
                                              <div class="teacher-content-bloc" style="float: left">
                                                  <div style="text-align: left">
                                                      <h3>Assistant Professor(HOD)</h3>
                                                      <h4> Computer Science & Engineering</h4>
                                                      <h4> 9800539233</h4>
                                                    <h4>debimps07@gmail.com</h4>                                                      
                                                      <h4>Specialization/Research : MSS,Robotics,Sensor Networks</h4>
                                                  </div>
                                              </div>
                                        </div>
                                      </div>
                    ...
                    <!-- /.col-lg-6 -->
                    <form action="mailto:chan.muk@gmail.com" method="post" enctype="text/plain">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               <span style="font-size: 24px;font-weight: bold">
                            ...
                            <div class="panel-body">
                                <div class="role col-md-11 col-sm-11 text-center" style="margin:10px;padding:5px!important">
                                        <div class="teacher-overview-block" style="padding: 10px;">
                                            <img style="width: 160px;height:180px; float: left;padding:10px" class="teacher-overview-image" src="../img/chandan.jpg">
                                              <div class="teacher-content-bloc" style="float: left">
                                                  <div style="text-align: left">
                                                    <h3>Assistant Professor</h3>
                                                      <h4> Computer Science & Engineering</h4>
                                                      <h4> 9831125100</h4>
                                                      <h4> chan.muk@gmail.com</h4>
                                                      <h4>Specialization/Research : Hadoop,Machine Learning</h4>
                                                  </div>
                                              </div>
                                        </div>
                                      </div>
                    ...
                    <!-- /.col-lg-6 -->
                    <form action="mailto:dddipak76@gmail.com" method="post" enctype="text/plain">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               <span style="font-size: 24px;font-weight: bold">
                               Mr. Dipak Kumar Dutta
                               <button style="float:right"  type="submit" class="btn btn-default">Send Mail</button>
                               </span>
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <div class="role col-md-11 col-sm-11 text-center" style="margin:10px;padding:5px!important">
                                        <div class="teacher-overview-block" style="padding: 10px;">
                                            <img style="width: 160px;height:180px; float: left;padding:10px" class="teacher-overview-image" src="../img/dipak.jpg">
                                              <div class="teacher-content-bloc" style="float: left">
                                                  <div style="text-align: left">
                                                    <h3>Assistant Professor</h3>
                                                      <h4> Computer Science & Engineering</h4>
                                                      <h4> 7584911530</h4>
                                                      <h4> dddipak76@gmail.com</h4>
                                                      <h4>Specialization/Research : Block Chain</h4>
                                                  </div>
                                              </div>
                                        </div>
                                      </div>
                    ...
                    <!-- /.col-lg-6 -->
                    <form action="mailto:arpita.imps@gmail.com" method="post" enctype="text/plain">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              <span style="font-size: 24px;font-weight: bold">
                            ...
                            <div class="panel-body">
                                <div class="role col-md-11 col-sm-11 text-center" style="margin:10px;padding:5px!important">
                                        <div class="teacher-overview-block" style="padding: 10px;">
                                            <img style="width: 160px;height:180px; float: left;padding:10px" class="teacher-overview-image" src="../img/arpita.jpg">
                                              <div class="teacher-content-bloc" style="float: left">
                                                  <div style="text-align: left">
                                                    <h3>Assistant Professor</h3>
                                                      <h4> Computer Science & Engineering</h4>
                                                      <h4> 9874918442</h4>
                                                      <h4> arpita.imps@gmail.com</h4>
                                                      <h4>Specialization/Research : Decision Support System</h4>
                                                  </div>
                                              </div>
                                        </div>
                                      </div>
                    ...
                    <form action="mailto:amrita.rinti@gmail.com" method="post" enctype="text/plain">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              <span style="font-size: 24px;font-weight: bold">
                            ...
                            <div class="panel-body">
                                <div class="role col-md-11 col-sm-11 text-center" style="margin:10px;padding:5px!important">
                                        <div class="teacher-overview-block" style="padding: 10px;">
                                            <img style="width: 160px;height:180px; float: left;padding:10px" class="teacher-overview-image" src="../img/amrita.jpg">
                                              <div class="teacher-content-bloc" style="float: left">
                                                  <div style="text-align: left">
                                                    <h3>Assistant Professor</h3>
                                                      <h4> Computer Science & Engineering</h4>
                                                      <h4> 9475617455</h4>
                                                      <h4> amrita.rinti@gmail.com</h4>
                                                      <h4>Specialization/Research : Bioinformatics,Image Processing</h4>
                                                  </div>
                                              </div>
                                        </div>
                                      </div>
                    ...
                    <!-- /.col-lg-6 -->
                    <form action="mailto:arupkumardutta@outlook.com" method="post" enctype="text/plain">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              <span style="font-size: 24px;font-weight: bold">
                            ...
                            <div class="panel-body">
                                <div class="role col-md-11 col-sm-11 text-center" style="margin:10px;padding:5px!important">
                                        <div class="teacher-overview-block" style="padding: 10px;">
                                            <img style="width: 160px;height:180px; float: left;padding:10px" class="teacher-overview-image" src="../img/arup.jpg">
                                              <div class="teacher-content-bloc" style="float: left">
                                                  <div style="text-align: left">
                                                    <h3>Technical Assistant</h3>
                                                      <h4> Computer Science & Engineering</h4>
                                                      <h4> 9614220940</h4>
                                                      <h4> arupkumardutta@outlook.com</h4>
                                                      <h4>Specialization/Research : Networking, Online Examination</h4>
                                                  </div>
                                              </div>
                                        </div>
                                      </div>

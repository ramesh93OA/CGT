...
%>
        <div id="wrapper">
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa fa-users fa-fw"></i> C.E</a>
                                    </li>
                                    <li>
            ...
            <div id="page-wrapper">
                  ...
                  <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3>Civil Engineering(C.E)</h3>
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <p>Civil Engineering is one of the broadest and oldest of the engineering disciplines,
                                 extending across many technical specialties. Civil Engineers plan, design, and supervise
                                  the construction of facilities essential to modern life like space satellites and launching
                                   facilities, offshore structures, bridges, buildings, tunnels, highways, transit systems, dams,
                                    airports, harbors, water supply system and wastewater treatment plants. A civil engineer is
                                     responsible for planning and designing a project, constructing the project to the required
                                      scale, and maintenance of the project. A civil engineer requires not only a high standard
                                       of engineering knowledge but also supervisory and administrative skills.</p>
                                 <a  class="btn btn-default btn-lg btn-block" 
                                 href="../students/page/ce_d.jsp">
                ...
                <form action="mailto:pilu.civil@gmail.com" method="post" enctype="text/plain">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span style="font-size: 24px;font-weight: bold">Smt. Piyali Basu Karmakar
                            ...
                            <div class="panel-body">
                                <div class="role col-md-11 col-sm-11 text-center" style="margin:10px;padding:5px!important">
                                        <div class="teacher-overview-block" style="padding: 10px;">
                                            <img style="width: 160px;height:180px; float: left;padding:10px" class="teacher-overview-image" alt="piyali mam" src="../img/priyali.jpg">
                                              <div class="teacher-content-bloc" style="float: left">
                                                  <div style="text-align: left">
                                                      <h3>Assistant Professor(HOD)</h3>
                                                      <h4> Civil Engineering</h4>
                                                      <h4> 7908500847</h4>
                                                      <h4> pilu.civil@gmail.com</h4>
                                                      <h4>Specialization/Research : Structural Engineering</h4>
                                                  </div>
                                              </div>
                                        </div>
                                      </div>
                    ...
                    <form action="mailto:psenimps@gmail.com" method="post" enctype="text/plain">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               <span style="font-size: 24px;font-weight: bold">Mr. Pradip Sen
                               <button style="float:right"  type="submit" class="btn btn-default">Send Mail</button></span>
                            </div>
                            ...
                            <div class="panel-body">
                                <div class="role col-md-11 col-sm-11 text-center" style="margin:10px;padding:5px!important">
                                        <div class="teacher-overview-block" style="padding: 10px;">
                                            <img style="width: 160px;height:180px; float: left;padding:10px" class="teacher-overview-image" src="../img/pradip.jpg">
                                              <div class="teacher-content-bloc" style="float: left">
                                                  <div style="text-align: left">
                                                    <h3>Assistant Professor</h3>
                                                      <h4> Civil Engineering</h4>
                                                      <h4> 9475395879</h4>
                                                      <h4> psenimps@gmail.com</h4>
                                                      <h4>Specialization/Research : Industrial Engineering and Management</h4>
                                                  </div>
                                              </div>
                                        </div>
                                      </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               <span style="font-size: 24px;font-weight: bold">Mr. Bablu Bhattacharya
                               <button style="float:right"  type="submit" class="btn btn-default">Send Mail</button></span>
                            </div>
                    ...
                    <form action="mailto:prabal.nitk@gmail.com" method="post" enctype="text/plain">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              <span style="font-size: 24px;font-weight: bold">Mr. Prabal Das 
                              <button style="float:right"  type="submit" class="btn btn-default">Send Mail</button></span>
                            ...
                            <div class="panel-body">
                                <div class="role col-md-11 col-sm-11 text-center" style="margin:10px;padding:5px!important">
                                        <div class="teacher-overview-block" style="padding: 10px;">
                                            <img style="width: 160px;height:180px; float: left;padding:10px" class="teacher-overview-image" src="../img/prabal.jpg">
                                              <div class="teacher-content-bloc" style="float: left">
                                                  <div style="text-align: left">
                                                    <h3>Assistant Professor</h3>
                                                      <h4> Civil Engineering</h4>
                                                      <h4> 8910398430</h4>
                                                      <h4> prabal.nitk@gmail.com</h4>
                                                      <h4>Specialization/Research : Water Resource Engineering</h4>
                                                  </div>
                                              </div>
                                        </div>
                                      </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              <span style="font-size: 24px;font-weight: bold">Mr. Abhishek Debroy
                              <button style="float:right"  type="submit" class="btn btn-default">Send Mail</button></span>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              <span style="font-size: 24px;font-weight: bold">Mr. Santanu Chakraborty
                              <button style="float:right"  type="submit" class="btn btn-default">Send Mail</button></span>
                            ...
                            <div class="panel-body">
                                <div class="role col-md-11 col-sm-11 text-center" style="margin:10px;padding:5px!important">
                                        <div class="teacher-overview-block" style="padding: 10px;">
                                            <img style="width: 160px;height:180px; float: left;padding:10px" class="teacher-overview-image" src="../img/santunu.jpg">
                                              <div class="teacher-content-bloc" style="float: left">
                                                  <div style="text-align: left">
                                                    <h3>Assistant Professor</h3>
                                                      <h4> Civil Engineering</h4>
                                                      
                                                      <h4>Specialization/Research : Seismic Science and Engineering</h4>
                                                  </div>
                                              </div>
                                        </div>
                                      </div>

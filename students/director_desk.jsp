...
%>
        ...
        <div id="wrapper">
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa fa-user-md fa-fw"></i> DIRECTOR'S DESK</a>
                                    </li>
                                    <li>
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Director's Desk</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
				...
				<div class="row" id="about">
					...
					<span style="font-family:Calibri,sans-serif">The technical education of the country is passing 
					through a very dismal state of affair. In this scenario we, IMPSCET is no different. But we are
					 fighters and we do not accept the defeat. In this direction under the stewardship of our Principal,
					  the faculties and staff members we go to the basic root of the cause and are trying to solve out the
					   problem at least as far as we are concerned. Therefore we are proud of them.</span><br>
                    <span style="font-family:Calibri,sans-serif">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    The time has also come now to shift our focus from just 
                    creating our engineers to delivering industry ready professionals. In this direction we depute our students 
                    for short term visits to industries. We organize special lectures by industry experts to support the students
                     interested in these areas. We arrange interaction between the alumni of the institute, the faculties and the
                      students. Alumni are encouraged to mentor the students to bring them in line with industry expectations. 
                      We encourage strong analytical skills, practical ingenuity and creativity of students.</span><br>
                    <span style="font-family:Calibri,sans-serif"></span></span><span style="font-size:11pt">
                    <span style="font-family:Calibri,sans-serif"><span style="font-size:12.0pt"><span style="font-size:18px">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;However</span></span></span></span><span style="font-size:18px"><span style="font-family:Calibri,sans-serif">
                     we strive for our success and contribute to the engineering field in general.</span></span></p>
			...
			<div class="col-md-4">
				<img alt="director" src="../img/director.jpg" style="max-width: 100%!important;padding: 10px;">
			</div>
			</div>
                <!-- /.row -->

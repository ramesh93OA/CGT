        ...
        <div id="wrapper">
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa fa-user-md fa-fw"></i> ADMINISTRATION</a>
                                    </li>
            ...
            <div id="page-wrapper">
				...
				<div class="row" id="about">
					...
					<p style="margin-left:0in; margin-right:0in"><span style="font-size:18px"><span style="font-family:Calibri,sans-serif">
					The College Administration, led by the Academic Registrar, works with students, academic and support staff to ensure the
					 effective administration of all matters of student recruitment, admissions, enrollment, teaching and assessment time-tabling,
					  the recording and processing of marks, student achievement statistics and course approval, monitoring and review. Student 
					  support and guidance are also integral parts of College Administration. The College Administration also processes student's
					   complaints, academic appeals, student disciplinary cases and issues related to data protection and freedom of information.
					   </span></span></p>

				</div>
			</div>
			<div class="col-md-4">
				<img alt="management" src="../img/management.jpg" style="max-width: 100%!important;padding: 10px;">
			</div>
			</div>
                <!-- /.row -->

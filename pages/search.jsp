		...
		if(document.f1.btn.value=="Edit")
			{
				...
				document.f1.txtdob.readOnly=false;
				document.f1.txtph.readOnly=false;
				document.f1.txtfname.readOnly=false;
				document.f1.txtmname.readOnly=false;
				document.f1.txtaddr.readOnly=false;
				document.f1.txtaltph.readOnly=false;
				document.f1.txtreli.readOnly=false;
				document.f1.txtgen.readOnly=false;
				document.f1.txtquota.readOnly=false;
				document.f1.txtstrm.readOnly=false;
				document.f1.txtbtch.readOnly=false;
				document.f1.txteml.readOnly=false;
				document.f1.txtdoj.readOnly=false;
				document.f1.txtfile.readOnly=false;
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="nav">
                                      <span style="font-size: 26px;" class="font_14"><a class="topnavlink">Students Seatrch</a></span>
                                      <span style="font-size: 17px;" class="font_14" ><a href="searchp.jsp" class="topnavlink">Payment Search</a></span>
  	                              </div> <br>
	<form method="post">
		<h2>Search By :</h2>
		<select name="selopt">
			...
			%>
			                      <form  role="form" id="frm" action="record_update.jsp" method="post" enctype="multipart/form-data">
			                               <div  class="form-group">
                                            <h3><button style="color: #ff0000" class="form-control" name="btn" value="Edit" onclick="abc()">Edit The Details</button></h3>
                                            </div>
                                      <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>ID</label>

...
MultipartRequest m = new MultipartRequest(request, "E:/Project/NewProject/CollegeManagementSystem/WebContent/upload_file");
	...
	//{
		...
		String tfee=m.getParameter("tution");
		String hfee=m.getParameter("hostel");
		String dop=m.getParameter("datep");
		
		//String photo=filename;
		try
		{
	stmt=con.prepareStatement("insert into payment(name,strm,sem,qt,tfee,hfee,dop) values(?,?,?,?,?,?,?)");
			stmt.setString(1,ename);
			stmt.setString(2,strm);
			stmt.setString(3,sem);
			stmt.setString(4,qta);
			stmt.setString(5,tfee);
			stmt.setString(6,hfee);
			stmt.setString(7,dop);

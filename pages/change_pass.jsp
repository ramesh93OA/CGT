...
%>
        ...
        <div id="wrapper">
                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li><a><i class="fa fa-edit fa-fw"></i> Change Password</a>
                            </li>
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sorry This Service Not Available</h1>
                        <img style="width:970px;height:450px;padding:10px" class="CGT-TEAM" alt="piyali mam" src="../img/CGT.jpg">
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->

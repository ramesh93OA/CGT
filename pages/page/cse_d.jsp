                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-user-secret fa-fw"></i> <%=session.getAttribute("username")%> <b class="caret"></b>
                        </a>
                  ...
                  <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <p><iframe frameborder="0" height="350" width="976" scrolling="yes"  
                                src="https://www.myklassroom.com/Engineering-branches/2/Computer-Science-&-Engg.-(CSE)"></iframe></p>

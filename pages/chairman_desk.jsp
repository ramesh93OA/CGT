...
%>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Chairman's Desk</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
				...
				<div class="row" id="about">
					...
					<p style="text-align:justify"><strong><span style="font-family:Verdana,Geneva,sans-serif"><span style="font-size:14px">
					In an endeavor to develop a Centre of Excellence, the synergy of complete educational institute should generate top-of-
					mind awareness to various segments of the society. The aspiring and ambitious young generation should look forward to a
					 value-based institutional set up with discipline, integrity, and on top pleasing manners. These sterling elements in 
					 character, as we know, are very rare in these days. Multitude of students, who lack opportunity to receive the best of
					  education, just beat about the bush. They become confused before stepping into a right track. With this purpose, IMPS
					   Educational Trust which was established during 2000, has founded IMPS College of Engineering and Technology in 2003. 
					   It passed through hitches arid glitches to reach a height of glory. The Technical and Research discipline, will, I am
					    sure be quite intriguing in the universe of true education compare with best in the world. The learning process and 
					    motivation with interest will enlarge the vision that is.... The Institute has been located in Malda to add new 
					    dimension to North Bengal and adjoining states. </span></span></strong></p>

                    <p style="text-align:justify"><strong><span style="font-family:Verdana,Geneva,sans-serif"><span style="font-size:14px">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The cream of faculty provides guidance with qualitative aspects 
                    to build careers acceptable to 'blue chip organization'. The scholars should also be groomed to become entrepreneur in 
                    their own initiative. IMPS College of Engineering and Technology --the pathway leads to progress with livewire passion 
                    and dynamism.</span></span></strong><br>
                    <strong><span style="font-size:16px"><span style="font-family:Verdana,Geneva,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Mr. B. Bhattacharjee<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; M-Tech (Civil), MBA</span></span></strong></p>
				</div>
			</div>
			<div class="col-md-4">
				<img alt="chairmansir" src="../img/chairman_sir.jpeg" style="max-width: 100%!important;padding: 10px;">
			</div>
			</div>
                <!-- /.row -->

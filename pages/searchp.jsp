...
<script>
	...
	{
		//alert("Hello");
		if(document.f1.btn.value=="Edit")
			{
				document.f1.txtname.readOnly=false;
				document.f1.txtstrm.readOnly=false;
				document.f1.txtsem.readOnly=false;
				document.f1.txtfquota.readOnly=false;
				document.f1.txttfee.readOnly=false;
				document.f1.txthfee.readOnly=false;
				document.f1.txtdop.readOnly=false;
				document.f1.btn.value="Update";
			}
		else
		
		{
			document.f1.btn.value=="Edit";
			document.f1.submit();
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="nav">
                                      <span style="font-size: 26px;" class="font_14"><a class="topnavlink">Payment Search</a></span>
                                      <span style="font-size: 17px;" class="font_14" ><a href="search.jsp" class="topnavlink">Students Search</a></span>
  	                              </div> <br>
	<form method="post">
		<h2>Search By :</h2>
		<select name="selopt">
			<option value="name">Name</option>
			<option value="dob">Date of Payments</option>
		</select>
...
if("Search".equals(request.getParameter("btnsearch")))
{
	...
	String q="select * from payment where "+opt+" like '"+val+"%'";
//	out.println(q+"<br>");
	try
	{
			                      ...
			                      <form  role="form" id="frm" action="record_update.jsp" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input name="txtname" id="sname" class="form-control" readonly value="<%=rs.getString(2)%>">
                                           </div>
                                           <div class="form-group">
                                            <label>STREAM *</label>
                                                <input name="txtstrm" id="strm" class="form-control" readonly value="<%=rs.getString(3)%>" >
                                                </div>
                                                <div class="form-group">
                                            <label>Semester *</label>
                                                <input name="txtsem" id="strm" class="form-control" readonly value="<%=rs.getString(4)%>" >
                                                </div>
                                            <div class="form-group">
                                               <label>QUATA *</label><br>
                                                 <input name="txtquota" id="quota" class="form-control" readonly value="<%=rs.getString(5)%>" >
                                            </div>
                                            
                                                
                                        <div class="form-group">
                                            <label>Tution Fee *</label>
                                                <input name="txttfee" id="strm" class="form-control" readonly value="<%=rs.getString(6)%>" >
                                                </div>
                                                <div class="form-group">
                                            <label>Hostel Fee *</label>
                                                <input name="txthfee" id="strm" class="form-control" readonly value="<%=rs.getString(7)%>" >
                                                </div>
                                            <div class="form-group">
                                                <label>Date OF Payment *</label>
                                                <input name="txtdop" class="form-control" id="datej" readonly value="<%=rs.getString(8)%>" >
                                            </div>
